...
class Freezer:
    ...
    def break_freezer(self):
        # Break freezer
        print("Freezer number " +
              str(self.attributes["number"]) + " is broken")
    ...
    def fix_freezer(self, tech_id):
        ...
        print("Technician " + str(tech_id) +
              " is fixing freezer number " + str(self.attributes["number"]))
        time.sleep(5)
    ...
    def update_temperature_control(self, temperature, humidity):
        ...
        print("Update from freezer " + str(self.attributes["number"]) + ": temperature: " + str(
            temperature) + ", humidity: " + str(humidity))
        self.save_to_json()
